          ...
          <div className="bg-white rounded-2xl p-8 max-w-md w-full">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Are you sure you want to delete <strong>{showDeleteConfirm.full_name}</strong> (ID: {showDeleteConfirm.employee_id})?
                <br/>
              ...
              <div className="flex space-x-4">
                ...
                <button
                  onClick={() => handleDeleteEmployee(showDeleteConfirm.employee_id)}
