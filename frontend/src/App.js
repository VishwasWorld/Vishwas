            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button
                  ...
                  className="flex items-center justify-center space-x-3 bg-blue-600 text-white p-4 rounded-lg hover:bg-blue-700 transition"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center space-x-3 bg-green-600 text-white p-4 rounded-lg hover:bg-green-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  disabled={!isLoggedInToday(user?.employee_id) || !location}
                  className="flex items-center justify-center space-x-3 bg-orange-600 text-white p-4 rounded-lg hover:bg-orange-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
