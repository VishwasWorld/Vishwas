        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-white">
                <h1 className="text-2xl font-bold tracking-wide">VISHWAS WORLD TECH</h1>
                <p className="text-blue-200 text-sm font-medium">PRIVATE LIMITED</p>
                <p className="text-blue-300 text-xs">HRMS Dashboard - Complete HR Solution</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden md:block text-right text-white">
              <p className="text-sm font-medium">100 DC Complex, Chandra Layout</p>
              <p className="text-xs text-blue-200">Bangalore - 560040</p>
              <p className="text-xs text-blue-300">+91-80-12345678</p>
            </div>
            ...
            <div className="text-right text-white">
              ...
              <p className="text-xs text-blue-300">{user?.designation} - {user?.department}</p>
            </div>
            
            {/* Logout Button */}
            <button
              onClick={logout}
              className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 shadow-lg hover:shadow-xl flex items-center space-x-2"
            >
